...
dev: globals check-env-vars ## Set Environment to DEV
	...
	$(eval export SYSTEM_DNS_ZONE_NAME=${DEPLOY_ENV}.system.lab2.workloady.paasmule.win)
	$(eval export APPS_DNS_ZONE_NAME=${DEPLOY_ENV}.apps.lab2.workloady.paasmule.win)
...
ci: globals check-env-vars ## Set Environment to CI
	...
	$(eval export SYSTEM_DNS_ZONE_NAME=${DEPLOY_ENV}.ci.system.workloady.paasmule.win)
	$(eval export APPS_DNS_ZONE_NAME=${DEPLOY_ENV}.ci.apps.workloady.paasmule.win)
...
staging: globals check-env-vars ## Set Environment to Staging
	...
	$(eval export SYSTEM_DNS_ZONE_NAME=staging.system.workloady.paasmule.win)
	$(eval export APPS_DNS_ZONE_NAME=staging.apps.workloady.paasmule.win)
