...
dev: globals check-env-vars ## Set Environment to DEV
	...
	$(eval export SYSTEM_DNS_ZONE_NAME=${DEPLOY_ENV}.system.lab2.workloadx.paasmule.win)
	$(eval export APPS_DNS_ZONE_NAME=${DEPLOY_ENV}.apps.lab2.workloadx.paasmule.win)
...
ci: globals check-env-vars ## Set Environment to CI
	...
	$(eval export SYSTEM_DNS_ZONE_NAME=${DEPLOY_ENV}.ci.system.workloadx.paasmule.win)
	$(eval export APPS_DNS_ZONE_NAME=${DEPLOY_ENV}.ci.apps.workloadx.paasmule.win)
...
staging: globals check-env-vars ## Set Environment to Staging
	...
	$(eval export SYSTEM_DNS_ZONE_NAME=staging.system.workloadx.paasmule.win)
	$(eval export APPS_DNS_ZONE_NAME=staging.apps.workloadx.paasmule.win)
