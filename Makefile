...
ci: globals check-env-vars ## Set Environment to CI
	...
	$(eval export SYSTEM_DNS_ZONE_NAME=${DEPLOY_ENV}.ci.system.paasmule.win)
	$(eval export APPS_DNS_ZONE_NAME=${DEPLOY_ENV}.ci.apps.paasmule.win)
...
staging: globals check-env-vars ## Set Environment to Staging
	...
	$(eval export SYSTEM_DNS_ZONE_NAME=staging.system.paasmule.win)
	$(eval export APPS_DNS_ZONE_NAME=staging.apps.paasmule.win)
